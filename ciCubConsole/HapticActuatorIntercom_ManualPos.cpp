...
// This program was modified to take position offset manually from the brake model.
//Brake pad position was set to the just near the contact position but it's a not contact position
// Press button 'o' to set position offset.
