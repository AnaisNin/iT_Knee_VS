...
hold on
plot(runTime_sitStand_exp,torqueKnee_sitStand_dTheta1_p,'c')
hold on
plot(runTime_sitStand_exp,torqueKnee_sitStand_dTheta1_m,'m')
legend 'Computed exp cond' 'plus delta height' 'minus delta height' 'plus delta theta1' 'minus delta theta 1'
xlabel 'Time (s)'
